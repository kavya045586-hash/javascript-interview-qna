...
- [x] [Data Types & typeof](./01-basics/data-types-typeof.md)
- [x] [Primitive vs Reference Types](./01-basics/primitive-vs-reference.md)
- [x] [== vs === and Type Coercion](./01-basics/equality-coercion.md)
...
- [x] [Microtask vs Macrotask Queue](./03-async/microtask-vs-macrotask.md)
- [x] [setTimeout vs setInterval](./03-async/settimeout-setinterval.md)
- [x] [Extra Topics & Quiz](./03-async/extrafile.md)

### 04-objects-arrays
- [x] [Object Creation & Shorthand](./04-objects-arrays/object-creation-shorthand.md)
- [x] [Object & Array Destructuring](./04-objects-arrays/object-array-destructuring.md)
- [x] [Shallow vs Deep Copy](./04-objects-arrays/shallow-vs-deep-copy.md)
- [x] [Prototypes & Inheritance](./04-objects-arrays/prototypes-inheritance.md)
- [x] [Classes, Constructor, super](./04-objects-arrays/classes-constructor-super.md)
- [x] [Getters/Setters & Static Methods](./04-objects-arrays/getters-setters-static.md)
- [x] [Array: map, filter, reduce](./04-objects-arrays/array-map-filter-reduce.md)
- [x] [Array: forEach, find, some/every](./04-objects-arrays/array-foreach-find-some-every.md)
- [x] [JSON.stringify / parse](./04-objects-arrays/json-stringify-parse.md)
